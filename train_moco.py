...
if __name__ == '__main__':
    ...
    # Augmentation
    # parser.add_argument("--resize", default=[0.2, 1.0], nargs='+', type=float)
    parser.add_argument("--resize", default=[256, 512], nargs='+', type=float)
    # parser.add_argument("--crop", default=224, type=int)
    parser.add_argument("--crop", default=[384, 384], nargs='+', type=int)
    ...
    parser.add_argument("--TH", default=[0.3,0.5], nargs='+',type=float)
